...
addsnv.py -v ../test_data/random_snvs.txt -f ../test_data/testregion_realign.bam -r $3 -o ../test_data/testregion_mut.bam -n $1 -c ../test_data/test_cnvlist.txt.gz -p $2 --minmutreads 25
if [ $? -ne 0 ]
then

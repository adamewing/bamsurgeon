...
addsnv.py -v ../test_data/snv_alttest.txt -f ../test_data/Homo_sapiens_chr22_bamsurgeon_assembly19.sorted.bam -r $3 -o ../test_data/testregion_mut.bam -n $1 -c ../test_data/test_cnvlist.txt.gz -p $2
if [ $? -ne 0 ]
then

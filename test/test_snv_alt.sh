...
python3 -O ../bin/addsnv.py -v ../test_data/snv_alttest.txt -f ../test_data/testregion_realign.bam -r $3 -o ../test_data/testregion_mut.bam -n $1 -c ../test_data/test_cnvlist.txt.gz -p $2
if [ $? -ne 0 ]; then

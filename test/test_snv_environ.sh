...
python3 -O ../bin/addsnv.py -v ../test_data/random_snvs.txt -f ../test_data/testregion_realign.bam -r $REF -o ../test_data/testregion_mut.bam -n 5 -c ../test_data/test_cnvlist.txt.gz --aligner mem --seed 1234

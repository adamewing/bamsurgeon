...
python3 -O ../bin/addsv.py -p 1 -v ../test_data/test_sv.txt -f ../test_data/testregion_realign.bam -r $1 -o ../test_data/testregion_sv_mut.bam --aligner mem --keepsecondary --seed 1234 --simerr 0.05
if [ $? -ne 0 ]; then

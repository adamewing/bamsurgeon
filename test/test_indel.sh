...
python3 -O ../bin/addindel.py -v ../test_data/test_indels.txt -f ../test_data/testregion_realign.bam -r $REF -o ../test_data/testregion_mut.bam --picardjar $1 --aligner mem --seed 1234

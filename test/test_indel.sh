...
addindel.py -v ../test_data/test_indels.txt -f ../test_data/Homo_sapiens_chr22_bamsurgeon_assembly19.sorted.bam  -r $2 -o ../test_data/testregion_mut.bam -c ../test_data/test_cnvlist.txt.gz -p $1 --seed 1234
if [ $? -ne 0 ]
then

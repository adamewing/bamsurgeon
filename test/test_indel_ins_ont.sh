...
python3 -O ../bin/addindel.py -v ../test_data/test_ont_indel_ins.txt -f ../test_data/testregion_ont.bam -r $REF -o ../test_data/testregion_ont_mut.bam -n 5 --picardjar $1 --aligner minimap2 --alignopts x:map-ont --seed 1234 --ignorepileup --single --mindepth 4

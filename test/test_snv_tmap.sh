...
python3 -O ../bin/addsnv.py --single -v ../test_data/random_snvs.txt -f ../test_data/testregion_tmap.bam -r $3 -o ../test_data/testregion_mut.bam -n $1 -p $2 --picardjar $4 --aligner tmap

        ...
        if not hasSNP or args.force:
            ...
            if args.single:
                if args.bwamem:
                    ...
                    aligners.remap_backtrack_bam(tmpoutbamname, 1, args.refFasta, mutid=mutid, paired=False)
            else:
                if args.bwamem:
                    ...
                    aligners.remap_backtrack_bam(tmpoutbamname, 1, args.refFasta, mutid=mutid, paired=True)
